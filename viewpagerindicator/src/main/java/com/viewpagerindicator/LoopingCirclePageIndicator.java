...
public class LoopingCirclePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final int count = ((LoopingPager) mViewPager.getAdapter()).getRealCount();
        if (count == 0) {
            return;
        }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if ((mViewPager == null) || (((LoopingPager) mViewPager.getAdapter()).getRealCount() == 0)) {
            return false;
        }
    ...
    public void setCurrentItem(int item) {
        ...
        mCurrentPage = item % ((LoopingPager) mViewPager.getAdapter()).getRealCount();
        invalidate();
    }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        mCurrentPage = position % ((LoopingPager) mViewPager.getAdapter()).getRealCount();
    ...
    public void onPageSelected(int position) {
        if (mSnap || mScrollState == ViewPager.SCROLL_STATE_IDLE) {
            mCurrentPage = position % ((LoopingPager) mViewPager.getAdapter()).getRealCount();
            mSnapPage = position % ((LoopingPager) mViewPager.getAdapter()).getRealCount();
            invalidate();
        }
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        mCurrentPage = savedState.currentPage % ((LoopingPager) mViewPager.getAdapter()).getRealCount();
        mSnapPage = savedState.currentPage % ((LoopingPager) mViewPager.getAdapter()).getRealCount();
        requestLayout();
    }
